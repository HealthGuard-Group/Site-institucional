...
function inserirAcao(descricaoDaAcao, statusAcao = true) {
    if (descricaoDaAcao.length > 500) {
        console.error("Descrição da Ação muito grande. Faça uma descrição com menos de 500 caracteres")
        return
    }
